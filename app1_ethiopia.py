...
vars['pit_data_filename'] = "pit_ethiopia.csv"
...
reform = Calculator.read_json_param_objects('app1_reform_ethiopia.json', None)
...
# dump out records
dump_vars = ['id_n', 'Year', 'weight', 'Employment_Income', 'pitax']
...
dumpdf.to_csv('app1-dump-ethiopia.csv', columns=column_order,
